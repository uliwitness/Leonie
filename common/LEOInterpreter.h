...
inline int32_t		LEOCastUInt32ToInt32( uint32_t inNum );
...
inline int16_t		LEOCastUInt16ToInt16( uint16_t inNum );
...
inline LEONumber	LEOCastUInt32ToLEONumber( uint32_t inNum );
